...
export default function AboutPage() {
  return (
    <main>
      ...
      <section className="cta-band"><div className="container cta-band__inner"><div><p className="eyebrow eyebrow--light">Put experience to work</p><h2>Make your property winter-ready.</h2></div><Link className="button button--light" href="/quote">Request a consultation <span>↗</span></Link></div></section>
    </main>
  );
}
