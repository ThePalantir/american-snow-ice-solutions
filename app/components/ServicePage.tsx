    ...
    <main>
      ...
      <section className="subhero subhero--service">
        ...
        <div className="container subhero__content">
          ...
          <h1>{service.title}</h1>
          <p>{service.summary}</p>
          <Link className="button button--signal" href="/quote">Plan this service <span aria-hidden="true">↗</span></Link>
        </div>
      </section>
      ...
      <section className="cta-band">
        <div className="container cta-band__inner">
          ...
          <Link className="button button--light" href="/quote">Request a site review <span aria-hidden="true">↗</span></Link>
        </div>
      </section>
    </main>
  );
