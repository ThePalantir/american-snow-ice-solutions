...
export default function ServiceAreasPage() {
  return (
    <main>
      ...
      <section className="section"><div className="container area-intro"><div><p className="eyebrow">Primary service region</p><h2>Eastern Pennsylvania and the surrounding markets.</h2><p>We currently serve eastern Pennsylvania, western New Jersey, southern New York, and northern Delaware. Coverage continues to grow, so properties just outside the listed area should still contact our team.</p><Link className="button button--dark" href="/schedule">Discuss your property <span>↗</span></Link></div><div className="coverage-map coverage-map--large"><span className="map-label map-label--pa">PA</span><span className="map-label map-label--nj">NJ</span><span className="map-label map-label--ny">NY</span><span className="map-label map-label--de">DE</span><div className="map-pulse"/><p>Operations center<br/><strong>Walnutport, PA</strong></p></div></div></section>
