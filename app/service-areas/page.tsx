...
export default function ServiceAreasPage() {
  return (
    <main>
      <section className="page-hero page-hero--map"><div className="container"><p className="eyebrow eyebrow--light major-section-label">Regional coverage</p><h1>Local command.<br />Multi-state reach.</h1><p>Centered in Walnutport and operating across the region’s most active commercial corridors.</p></div></section>
