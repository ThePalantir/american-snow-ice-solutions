...
export default function ServicesPage() {
  return (
    <main>
      ...
      <section className="cta-band"><div className="container cta-band__inner"><div><p className="eyebrow eyebrow--light">Your property. Your priorities.</p><h2>Start with an operating conversation.</h2></div><Link className="button button--light" href="/quote">Request a risk consultation <span aria-hidden="true">↗</span></Link></div></section>
    </main>
  );
}
