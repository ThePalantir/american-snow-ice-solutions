...
export default function SnowIceSciencePage() {
  return (
    <main>
      ...
      <section className="section section--dark"><div className="container"><div className="section-heading section-heading--light"><p className="eyebrow eyebrow--light">Equipment and material stewardship</p><h2>Remove mechanically. Apply deliberately. Document the work.</h2></div><div className="detail-grid detail-grid--dark"><article><span>01</span><h3>Sectional snow pushers</h3><p>Contour-following sections can improve pavement contact and reduce residual snow in appropriate applications, supporting cleaner mechanical removal.</p></article><article><span>02</span><h3>Dedicated sidewalk machines</h3><p>Purpose-built compact equipment supports more consistent pedestrian-route service while reducing dependence on large hand-shoveling crews.</p></article><article><span>03</span><h3>Calibrated application</h3><p>Material selection and application rates should reflect pavement temperature, product guidance, site conditions, and the service objective.</p></article><article><span>04</span><h3>Electric application equipment</h3><p>Electric sprayers and spreaders can reduce small-engine use at the point of application; actual environmental benefit depends on the full operating context.</p></article></div></div></section>
