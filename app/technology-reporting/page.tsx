...
export default function TechnologyReportingPage() {
  return (
    <main>
      ...
      <section className="section section--dark"><div className="container platform-grid"><div className="platform-intro"><p className="eyebrow eyebrow--light major-section-label">YETI Snow Management</p><Image className="yeti-logo" src="/media/partners/yeti-logo.jpg" alt="YETI Snow Tracker logo" width={500} height={500} sizes="(max-width: 760px) 96px, 112px" /><h2>Purpose-built control for snow operations.</h2><p>YETI’s published capabilities include dispatch, route and crew visibility, service history, site photos, notes, weather conditions, time-on-site information, and client-facing access. American Snow And Ice Solutions uses the platform to support field coordination and service documentation.</p><a className="button button--signal" href="https://www.yetisnow.com/" target="_blank" rel="noreferrer">Visit YETI Snow Management <span aria-hidden="true">↗</span></a></div><div className="platform-list"><div><strong>Dispatch &amp; route status</strong><span>See where work stands across assigned properties.</span></div><div><strong>Site records</strong><span>Connect services, photos, notes, and conditions to the property.</span></div><div><strong>Client visibility</strong><span>Support clearer answers when stakeholders ask what happened and when.</span></div></div></div></section>

      <section className="section"><div className="container partner-evidence"><article><p className="eyebrow">Forecast support</p><h2>The Weather Pros</h2><p>The Weather Pros provides business-focused snow and ice forecasts, storm tracking, alerts, and meteorological insight. American Snow And Ice Solutions reports using that service as an operational weather input.</p><a className="button button--signal" href="https://www.theweatherpros.com/" target="_blank" rel="noreferrer">Review the provider <span aria-hidden="true">↗</span></a></article><article><p className="eyebrow">Post-event context</p><h2>WeatherWorks</h2><p>WeatherWorks provides professional meteorological services and certified snowfall reporting designed to support post-storm documentation and contract review.</p><a className="button button--signal" href="https://weatherworksinc.com/" target="_blank" rel="noreferrer">Review the provider <span aria-hidden="true">↗</span></a></article></div><p className="claim-note">Provider capabilities are verified from current public materials. American Snow And Ice Solutions account scope and client access features should be confirmed before launch.</p></section>
