...
export default function TechnologyReportingPage() {
  return (
    <main>
      ...
      <section className="section"><div className="container partner-evidence"><article><p className="eyebrow">Forecast support</p><h2>The Weather Pros</h2><p>The Weather Pros provides business-focused snow and ice forecasts, storm tracking, alerts, and meteorological insight. American Snow And Ice Solutions reports using that service as an operational weather input.</p><a className="text-link" href="https://www.theweatherpros.com/" target="_blank" rel="noreferrer">Review the provider →</a></article><article><p className="eyebrow">Post-event context</p><h2>WeatherWorks</h2><p>WeatherWorks provides professional meteorological services and certified snowfall reporting designed to support post-storm documentation and contract review.</p><a className="text-link" href="https://weatherworksinc.com/" target="_blank" rel="noreferrer">Review the provider →</a></article></div><p className="claim-note">Provider capabilities are verified from current public materials. American Snow And Ice Solutions account scope and client access features should be confirmed before launch.</p></section>
