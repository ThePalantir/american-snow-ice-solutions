...
export default function TechnologyReportingPage() {
  return (
    <main>
      ...
      <section className="cta-band"><div className="container cta-band__inner"><div><p className="eyebrow eyebrow--light">Make the record part of the plan</p><h2>Ask what your stakeholders need to see after a storm.</h2></div><Link className="button button--light" href="/schedule">Schedule a consultation <span aria-hidden="true">↗</span></Link></div></section>
    </main>
  );
}
